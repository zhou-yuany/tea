<template>
  <div class="pickup_box">
    ...
    <div class="pickupk white_bg">
      ...
      />
      <el-button type="button" class="lightblue_bg white" @click="onSure(1)"
        >确定</el-button
      >
    </div>
    <ul class="numk">
      ...
      <!-- <li class="zero" @click="handleClick(item)">0</li> -->
      <li class="clearkk" @click="clearNo">
        <img src="../../static/clear.png" alt="" />
      </li>
    </ul>
  </div>
</template>
