<template>
  <div class="xq_box">
    <!-- 选项卡 -->
    <ul class="tabs darkwhite_bg" ref="gettabheight">
      <li
        class="tab"
    ...
    <div class="con">
      ...
      <div
        class="con_boxa"
        v-if="current == 0 && !ishiddens && !ismake && divideAccounts == 2"
      ...
      >
        ...
        <div class="xqks" :style="{ height: xqheight + 'px' }">
      ...
      >
        ...
        <div v-else>
          <div class="pick"><img src="/static/pic.png" alt="" /></div>
          <div class="blue tips">
            <p>制作完成</p>
            <p>请取走饮品</p>
          </div>
      ...
      <div class="con_boxe" v-if="current == 4">
        <div class="searchk">
          <div class="searchk_l gray_bg">
            <img src="/static/search.png" alt="" @click="goSures()" />
            <input
              type="text"
              class="gray_bg"
              placeholder="请输入要查询的内容"
        ...
        <div class="grayc" v-if="isFormula">
          <div class="white_bg whitek">
            <div class="tc_title">
              <p>配方</p>
              <img src="/static/x.png" alt="" @click="goClose()" />
            </div>
      ...
      <div class="con_boxf" v-if="current == 5">
        <div class="searchk">
          <div class="searchk_l gray_bg">
            <img src="/static/search.png" alt="" @click="goSurea" />
            <input
              type="text"
              class="gray_bg"
              placeholder="请输入订单编号"
              v-model="batchUseQuery.orderNum"
            />
          </div>
          <img
            src="/static/list.png"
...
export default defineComponent({
      ...
      tabs: [
        {
          id: 0,
          title: "商品",
          path: "/static/ico6.png",
          src: "/static/ico6_on.png",
        },
        {
          id: 1,
          title: "订单",
        ...
        },
        {
          id: 3,
          title: "原材料",
          path: "/static/ico9.png",
          src: "/static/ico9_on.png",
        },
        {
          id: 5,
          title: "物料消耗",
  ...
  mounted() {
    ...
    this.height =
      windowheight - tabheight - localStorage.getItem("touheight") - 4;

    this.xqheight =
      windowheight - tabheight - localStorage.getItem("touheight") - 74;

    this.ypheight =
      windowheight - tabheight - localStorage.getItem("touheight") - 150;

    this.turnoverheight =
      windowheight - tabheight - localStorage.getItem("touheight") - 176;

    this.materialheight =
      windowheight - tabheight - localStorage.getItem("touheight") - 196;
    ...
    if (this.current == 0) {
      ...
      this.getsocketData = (e) => {
        ...
        if (data) {
          ...
          if (data != "ping" && JSON.parse(data).message == "饿了么订单取消") {
            // 已经建立了连接
            this.getOrderList();
            // this.playVoice("您有新的订单，请及时处理")
          }
      ...
      homeApi
        ...
        .then((res) => {
          if (res.code == 20000) {
            ...
            this.print1();
            this.printOrders();
            // let machineNo = res.data.machineNo;
            // 传递给机器
            // let orderObj = {};
            // orderObj.orderId = order.id;
            // orderObj.goodList = [];
            // let obj = {};
            // obj.spId = order.shopId;
            // // obj.goodId = order.goodsId;
            // obj.machineNo = machineNo;
            // obj.bx =
            //   this.guige[this.currentsp].name.indexOf("大") > -1
            //     ? 1
            //     : this.guige[this.currentsp].name.indexOf("中") > -1
            //     ? 2
            //     : 3;
            // obj.td =
            //   this.sweet[this.currentspb].name.indexOf("正常") > -1
            //     ? 1
            //     : this.sweet[this.currentspb].name.indexOf("七分") > -1
            //     ? 2
            //     : 3;
            // obj.wd =
            //   this.temperature[this.currentspa].name.indexOf("正常") > -1
            //     ? 1
            //     : this.temperature[this.currentspa].name.indexOf("少") > -1
            //     ? 2
            //     : this.temperature[this.currentspa].name.indexOf("常温") > -1
            //     ? 3
            //     : 4;
            // let goodInfo = "";
            ...
            // 传给机器
            // let outletObj = {};
            // outletObj.outletVoList = outletList;
            // this.doOrder1(outletObj);

            // sendWSPush("handleOrder:" + JSON.stringify(orderObj));
            // 制作完成展示 待接收处理完成的socket
          }
        });
    },
